...
class SignUpForm extends React.Component {
    ...
    render(){
        return <Box sx={{width: "100%", height: "100%", border: "1px solid white", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
            ...
            <TextField onChange={e=> this.setState({username: e.target.value})} sx={{width: "70%"}} helperText="Please Confirm password" id="demo-helper-text-misaligned" label="Confirm password"/>
            <Box sx={{width: "70%"}}>
